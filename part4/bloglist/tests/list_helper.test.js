...
describe("favorite blog helper", () => {
  ...
  test("when list has one blog, returns that blog with simplified fields", () => {
  ...
  test("when list has many blogs, returns the one with the highest likes", () => {
    const expectedResult = {
      title: "Another lady's blog",
      author: "Some Lady",
      likes: 15,
